...
connectiondb = mysql.connector.connect(host="localhost",user="root",passwd="Anurag@2002", database="user")
...
def Book_log():
    ...
    Label(r_0,text="").pack()
    Button(r_0,text='Registration', height="1",width="20", bd=8, font=('arial', 12, 'bold'), fg="white", bg="grey", command=register).pack()
    Label(r_0,text="").pack()
